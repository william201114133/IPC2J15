...
public partial class EditaCliente : System.Web.UI.Page
{
    ...
    {
        local = "UPDATE Cliente SET apellidos='" + TextBox1.Text + "', nombres='" + TextBox2.Text + "',dpi=" + TextBox3.Text + ",nit=" + TextBox4.Text + ",telefono=" + TextBox5.Text + ",direccion='" + TextBox6.Text + "',tarjeta=" + TextBox7.Text + ""+
    ...
    public Boolean datoscliente(int user)
    {
        try
        {
            ...
            query = "SELECT idCliente, apellidos, nombres, dpi, nit, telefono, direccion, tarjeta FROM Cliente" +
